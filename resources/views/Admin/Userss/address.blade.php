...
@section('content')
   ...
   <div class="mws-panel grid_8">
    ...
    <span>
      <i class="icon-table"></i>会员收货地址列表</span>
      </div>
         ...
         <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
            ...
            <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
               ...
               <tr role="row">
                  ...
                  <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 197px;">电话</th>
                  <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 197px;">地址</th>
               ...
               <tr class="odd">
                  ...
                  <td class=" " style="text-align:center">{{$row->huo}}</td>
