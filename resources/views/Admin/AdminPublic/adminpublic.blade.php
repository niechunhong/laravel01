          ...
          <div id="mws-header" class="clearfix">
            ...
            <div id="mws-logo-container">
              ...
              <div id="mws-logo-wrap">
                <img src="/static/admin/images/mws-logo.png" alt="mws admin"></div>
            </div>
            ...
            <div id="mws-user-tools" class="clearfix">
              ...
              <div id="mws-user-info" class="mws-inset">
                ...
                <div id="mws-user-photo">
                  <img src="/static/admin/example/profile.jpg" alt="User Photo"></div>
              ...
              <div id="mws-navigation">
                <ul>
                  <li>
                    ...
                    <ul class="closed">
                      <li>
                        <a href="/adminusers/create">用户添加</a></li>
                      <li>
                        <a href="/adminusers">用户列表</a></li>
                    </ul>
                  </li>
                  <li>
                    <a href="#">
                      <i class="icon-user"></i>会员管理</a>
                    <ul class="closed">
                      <li>
                        <a href="/adminuserss/create">会员添加</a></li>
                      <li>
                        <a href="/adminuserss">会员列表</a></li>
                    </ul>
                  </li>
                  <li>
                    <a href="#">
                      <i class="icon-th-list"></i>分类管理</a>
                    <ul class="closed">
                      <li>
                        <a href="">分类添加</a></li>
                      <li>
